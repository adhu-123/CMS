...
<?php
 ...
 $qryy= "SELECT * FROM `employees` WHERE `emp_id`='CRP001'";
...
<header> <?php echo $data['name']; ?></header><br><br><br>
<img src="../staff/image7.jpeg" alt="img1">
<div class="text-container">
   ...
   <h3> <p><b><span  style="color:green;"> Experience: </span> <?php echo $data['experience']; ?></b></p></h3>
    ...
    <p> <?php echo $data['name']; ?> was born on <b><?php echo $data['date_of_birth']; ?></b> in <?php echo $data['address']; ?>. His parents are <?php echo $data['parents']; ?> , currently he is <?php echo $data['married']; ?>. </p>
...
<a href="emp7.php" style=" position: relative;
    text-decoration:none;
    color:red;
    margin:auto;
    border:2px;
