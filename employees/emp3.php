...
<body>
    ...
    <form action="emp3.php" method="POST"enctype="multipart/form-data">
...
if (isset($_POST['submit'])) {
    ...
    $qry="UPDATE `employees` SET `name`='$name',`date_of_birth`='$date',`address`='$address',`parents`='$parents',`married`='$married',`profession`='$profession',`experience`='$experience',`nationality`='$nationality',`qualification`='$qualification' WHERE `emp_id`='TM2010'";
