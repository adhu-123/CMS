...
<?php
 ...
 $qryy= "SELECT * FROM `employees` WHERE `emp_id`='OP2001'";
...
<header>Alankarkitha</header><br><br><br>
<img src="../staff/image2.jpeg" alt="img1">
...
<a href="emp4.php" style=" position: relative;
    text-decoration:none;
    color:red;
    margin:auto;
    border:2px;
