...
<?php
 ...
 $qryy= "SELECT * FROM `employees` WHERE `emp_id`='DDP090'";
...
<header>Sophia Patel</header><br><br><br>
<img src="../staff/image5.jpeg" alt="img1">
...
<a href="emp5.php" style=" position: relative;
    text-decoration:none;
    color:red;
    margin:auto;
    border:2px;
