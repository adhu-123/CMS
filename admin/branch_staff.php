...
<hr>
<h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #f9829b;color:white;">Staff</h1>
</div>
	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<a class="btn btn-block btn-sm btn-default btn-flat border-primary " href="new_staff.php"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
		<div class="card-body">
