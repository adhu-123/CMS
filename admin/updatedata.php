...
<hr>
<h1 align='center' style="text-shadow: 0.1em 0.1em 0.15em #f9829b;color:white;">Update Information</h1>
</div>
<?php
session_start();
...
<tr style="background-color: grey;color:white;">
    ...
    if(mysqli_num_rows($run)<1){
        ...
        <tr align="center">
            ...
            <td><a href="updateddata.php?sid=<?php echo $data['c_id']; ?>">Edit</a></td>
        </tr>
        <?php
        }
    }
